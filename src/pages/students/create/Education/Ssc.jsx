...
function Ssc({ boardData, passingYearData, groupData }) {
  // console.log("passingYearData :>> ", passingYearData);
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log("res :>> ", res);
    if (res.status === 201) {
      toastifyAlertSuccess("Ssc added Successfully", "top-center");
      setState({
        // name: "",
        examination_id: "",
        roll_no: "",
    ...
    <div className="jsc">
      <div className="student__header d-flex justify-content-between">
        <div className="header__level">
          <span>S.S.C or Equivalent Level</span>
        </div>
        <div>
      ...
      <div className="inputs row gy-5">
        ...
        {/* <div className="col-md-6">
          <input className="" type="email" placeholder="Result*" />
        </div> */}
        <div className="col-md-6">
